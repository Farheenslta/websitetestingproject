...
public class ActionsClassCacheElementGoogleTextBox 
{
	public static void main(String[] args) throws Exception
	{
		...
		List<WebElement> l1=driver.findElements(By.xpath("//*[@role='listbox']/li/descendant::span"));
		System.out.println("Count of elements in cache are: " + l1.size());
		...
		for(int i=0;i<l1.size();i++)
		{
			...
			if(x.equalsIgnoreCase("virat kohli"))
			{
				flag=1;
